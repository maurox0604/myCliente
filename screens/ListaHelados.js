...
export default function ListaHelados({ deletItem = false, editItem = false }) {
  ...
  const { categorias, categoriaActiva, setCategoriaActiva } = useCategorias();
  ...
  const heladosPorCategoria = categoriaActiva
    ? filteredHelados.filter((h) => h.id_categoria === categoriaActiva)
    : filteredHelados;
      ...
      <SafeAreaView style={styles.container}>
        ...
        {showSedeModal && (
          <View style={styles.overlay}>
            ...
            <View style={styles.modal}>
              <SelectorSedeModal onClose={() => setShowSedeModal(false)} />
            </View>
          </View>
        )}
        ...
        {showMenuVenta && (
          <View style={styles.overlay}>
            ...
            <View style={styles.modal}>
              <MenuVenta onClose={() => setShowMenuVenta(false)} />
            </View>
          </View>
        )}
      </SafeAreaView>
